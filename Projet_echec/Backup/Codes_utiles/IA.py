...
train = AI_function.get_data(r'AI_model\Training_image')
val = AI_function.get_data(r'AI_model\Test_image')
...
# AI_function.save_CNN_model(model, 'model.json', 'model.h5')
